$(document).ready(function () {
	...
	$('area').on('click', function () {
		...
		switch (provincia) {
			...
			case "cadiz":
			case "almeria":
				window.location.href = `http://localhost/proyecto-final-master/andalucia.php?provincia=${encodeURIComponent(provincia)}`;
				break;
			case "huesca":
			case "zaragoza":
			case "teruel":
				window.location.href = `http://localhost/proyecto-final-master/aragon.php?provincia=${encodeURIComponent(provincia)}`;
				break;
